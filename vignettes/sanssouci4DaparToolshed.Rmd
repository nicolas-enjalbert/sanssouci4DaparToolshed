...
library(sanssouci)
sanssouci_object <- wrapper_QFtoSansSouci(obj)
```
...
VolcanoPlot_ggplot(pval = pval, logFC = logFC, 
                   sanssouci_object = sanssouci_object_cal_limma,  
...
```{r}
obj <- export2dapartoolshed(sanssouci_obj = sanssouci_object_cal_limma, 
